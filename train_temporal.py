...
def parse_option():
    ...
    parser.add_argument('--batch_size', type=int, default=224, help='batch_size')                   #Use bsz based on Chen et al. 2020 Table C.1
    parser.add_argument('--num_workers', type=int, default=18, help='num of workers to use')
    parser.add_argument('--epochs', type=int, default=200, help='number of training epochs')

    # optimization
    parser.add_argument('--learning_rate', type=float, default=0.26, help='learning rate')          #lr = 0.3 * bsz/256 
