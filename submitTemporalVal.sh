...
python /home/ubuntu/CMC/LinearProbing.py --data_folder /movie-associations/imagenet \
 ...
 --view temporal \
 --resume /movie-associations/saves/val-saves/temporal-trained/calibrated_memory_nce_16384_alexnet_lr_0.03_decay_0.0001_bsz_128_view_temporal_bsz_256_lr_0.1_decay_0_view_temporal/ckpt_epoch_29.pth