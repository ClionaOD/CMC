...
python3 /home/clionaodoherty/CMC/train_CMC.py \
    ...
    --epochs 80 \
    --distort True \
    --resume /home/clionaodoherty/movie-associations/saves/temporal/finetune1sec/movie-training-distorted/pretrained_memory_nce_16384_alexnet_lr_0.03_decay_0.0001_bsz_128_sec_1_view_temporal/ckpt_epoch_78.pth