...
#SBATCH -J train_CMC_singleBatch
#SBATCH --output=/movie-associations/logs/valSingle-%j.out
#SBATCH --error=/movie-associations/logs/valSingle-%j.err


python /home/ubuntu/CMC/LinearProbing.py --data_folder /movie-associations \
