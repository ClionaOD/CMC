...
#
#SBATCH --output=/home/clionaodoherty/movie-associations/logs/fineTune_distort_300sec%j.out
#SBATCH --error=/home/clionaodoherty/movie-associations/logs/fineTune_distort_300sec%j.err
#SBATCH --gres=gpu:2
...
python3 /home/clionaodoherty/CMC/train_CMC.py \
    ...
    --model_path /home/clionaodoherty/movie-associations/saves/temporal/finetune30sec/movie-training-distorted \
